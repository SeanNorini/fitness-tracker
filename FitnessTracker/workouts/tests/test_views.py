...
class TestAddSetView(TestViews):
    ...
    def test_add_set(self):
        ...
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed("workouts/add_set.html")
...
class TestAddExerciseView(TestViews):
    def test_add_exercise(self):
        ...
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed("workouts/exercise.html")
...
class TestWorkoutView(TestViews):
    ...
    def test_get_ajax(self):
        ...
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, "workouts/workout_session.html")
...
class TestSelectWorkoutView(TestViews):
    ...
    def test_get(self):
        ...
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, "workouts/workout.html")
