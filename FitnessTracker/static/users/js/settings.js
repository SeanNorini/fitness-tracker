...
function changePasswordEventListeners() {
  ...
  changePassword.addEventListener("click", (e) => {
    ...
    fetch(`http://${domain}/user/change_password/`, {
      method: "POST",
      headers: {
...
function loadUserSettings() {
  fetch(`http://${domain}/user/settings`, {
    method: "GET",
    headers: {
      "X-Requested-With": "XMLHttpRequest",
    },
...
function accountSettingsListeners() {
  ...
  updateAccountSettings.addEventListener("click", (e) => {
    ...
    fetch(`http://${domain}/user/settings/update_account_settings/`, {
      method: "POST",
      headers: {
        "X-Requested-With": "XMLHttpRequest",
      },
      ...
      .then((contentHTML) => {
        const accountSettingsContainer =
          document.querySelector(".account_settings");
...
function bodyCompositionSettingsListeners() {
  ...
  updateBodyCompositionSettings.addEventListener("click", (e) => {
    ...
    fetch(`http://${domain}/user/settings/update_body_composition_settings/`, {
      method: "POST",
      headers: {
        "X-Requested-With": "XMLHttpRequest",
      },
      ...
      .then((response) => response.text())
      .then((contentHTML) => {
        const bodyCompositionSettingsContainer = document.querySelector(
          ".body_composition_settings",
        );
